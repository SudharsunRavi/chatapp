          ...
          <div className="border border-slate-500 px-20 py-20 rounded-xl ">
              ...
              <div>
                  <form>
                    ...
                    <div className="join">
                        <input className="join-item btn" type="radio" name="options" aria-label="Male" />
              ...
              <div className="mt-2">
                  <span className="text-sm">Already a user? <a className="text-primary cursor-pointer">Sign In</a></span>
              </div>
          </div>
      </div>
    )
